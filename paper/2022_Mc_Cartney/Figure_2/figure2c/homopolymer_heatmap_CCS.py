...
files = ["./inputs/t2t_chm13_20200921_hifi_markerandlength_runlength_matrix/t2t_chm13_v1_hifi_markerandlength_RLE_matrix.run_lengths.A.tsv",
         "./inputs/t2t_chm13_20200921_hifi_markerandlength_runlength_matrix/t2t_chm13_v1_hifi_markerandlength_RLE_matrix.run_lengths.C.tsv",
         "./inputs/t2t_chm13_20200921_hifi_markerandlength_runlength_matrix/t2t_chm13_v1_hifi_markerandlength_RLE_matrix.run_lengths.G.tsv",
         "./inputs/t2t_chm13_20200921_hifi_markerandlength_runlength_matrix/t2t_chm13_v1_hifi_markerandlength_RLE_matrix.run_lengths.T.tsv"]
names = ["A", "C", "G", "T"]
...
fig.tight_layout()
plt.suptitle("Run-length distribution observed in PacBio CCS marker assisted alignments.", fontsize=16, y=0.8)
# plt.show()
plt.savefig('./Homopolymer_distribution_CCS_'+ str(RLE_max) +'.png', format='png', dpi=300)