...
include { WINNOWMAP_MAP    as WINNOWMAP_MAP_R3         } from '../modules/winnowmap'
include { WINNOWMAP_MERGE  as WINNOWMAP_MERGE_HIFI_R3  } from '../modules/winnowmap'
include { WINNOWMAP_MERGE  as WINNOWMAP_MERGE_ONT_R3   } from '../modules/winnowmap'
include { WINNOWMAP_FILTER as WINNOWMAP_FILTER_R3      } from '../modules/winnowmap'
include { SAM2PAF          as SAM2PAF_R3               } from '../modules/winnowmap'
include { BWA_MAP          as BWA_MAP_R3               } from '../modules/bwa'
include { BWA_MERGE        as BWA_MERGE_R3             } from '../modules/bwa'
...
workflow MAPPING_R3 {
    ...
    def mapped   = WINNOWMAP_MAP_R3( hifiInput.mix(ontInput) )
    ...
    def bwaMapped = BWA_MAP_R3( bwa_refs.combine(allBwaReads) )
    def bwaMerged = BWA_MERGE_R3( bwaMapped.groupTuple(by: [0, 1, 2]) )
