...
workflow DEEPVARIANT_R5 {
    ...
    def r9_input = ( params.ont_chemistry == 'r9' )
        ...
        : Channel.empty()
    def per_chr = PEPPER_MARGIN_DV_R5(r9_input)
    DV_MERGE_CHR_VCFS_R5( per_chr.groupTuple(by: [0, 1]) )
    ...
    def dv_vcfs_ch = DV_POSTPROCESS_HYB_R5.out[0].mix( DV_POSTPROCESS_ONT_R5.out[0] )
