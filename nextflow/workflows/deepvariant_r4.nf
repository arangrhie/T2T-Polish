...
workflow DEEPVARIANT_R4 {
    ...
    def r9_input = ( params.ont_chemistry == 'r9' )
        ...
        : Channel.empty()
    def per_chr = PEPPER_MARGIN_DV_R4(r9_input)
    DV_MERGE_CHR_VCFS_R4( per_chr.groupTuple(by: [0, 1]) )
    ...
    def dv_vcfs_ch = DV_POSTPROCESS_HYB_R4.out[0].mix( DV_POSTPROCESS_ONT_R4.out[0] )
