...
def plot_homopolmer_support(bed_file, axs):
    ...
    for line in bed_file_records:
        ...
        read_hom_observed = [int(r)-R for r in read_hom_observed.split(',')]
...
if __name__ == '__main__':
    ...
    fig, axes = plt.subplots(2, len(all_beds_v09), figsize=(6, 6))
    ...
    plt.savefig('./CHM13_v0.9_vs_v1.0_dimer_support.pdf', format='pdf', dpi=300)
    # plt.show()
